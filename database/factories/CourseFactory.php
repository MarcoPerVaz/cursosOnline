...
$factory->define(App\Course::class, function (Faker $faker) {
    ...
    return [
        /*  */
        'teacher_id'        => \App\Teacher::all()->random()->id, /* Devuelve cualquier id de teacher_id */
        'category_id'       => \App\Category::all()->random()->id,/* Devuelve cualquier id de category_id */
        'level_id'          => \App\Level::all()->random()->id,/* Devuelve cualquier id de level_id */
        'name'              => $name,
        'slug'              => str_slug($name, '-'),
